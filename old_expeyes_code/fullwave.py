...
def update():
	...
	try:
		...
		data[2][0], data[2][1], data[3][0], data[3][1] = p.capture4(NP,delay)

		g.delete_lines()
		g.line(data[0][0], data[0][1],0)
		g.line(data[1][0], data[1][1],1)
		g.line(data[2][0], data[2][1],2)
	except:
...
set_frequency(1)
eyeplot.pop_image('pics/fullwave.png', _('Fullwave Rectifier'))
root.title(_('Fullwave Rectifier'))
root.after(10,update)
root.mainloop()
