...
#
# Created: Fri Jul 21 19:49:59 2017
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dirChange_2 = QtGui.QPushButton(self.frame)
        self.dirChange_2.setMinimumSize(QtCore.QSize(0, 0))
        self.dirChange_2.setMaximumSize(QtCore.QSize(80, 30))
        self.dirChange_2.setObjectName(_fromUtf8("dirChange_2"))
        self.horizontalLayout_10.addWidget(self.dirChange_2)
        ...
        QtCore.QObject.connect(self.dirChange_2, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.refresh)
        QtCore.QObject.connect(self.listWidget, QtCore.SIGNAL(_fromUtf8("currentTextChanged(QString)")), Form.itemClicked)
    ...
    def retranslateUi(self, Form):
        ...
        self.dirChange_2.setText(_translate("Form", "refresh", None))
